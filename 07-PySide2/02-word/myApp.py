...
class MyQtApp(mainwindow.Ui_MainWindow,QtWidgets.QMainWindow):
    ...
    def my_read_BT(self):
        ...
        my_file_path = QtWidgets.QFileDialog.getOpenFileName(self,"open file",'/Users/andrew/')
        print(my_file_path)
    ...
    def my_write_BT(self):
        ...
        my_file_path = QtWidgets.QFileDialog.getSaveFileName(self,"save file", '/Users/andrew/')
        print(my_file_path)
